...
class RegisterButton @JvmOverloads constructor(
    context: Context,
    ...
    init {
        ...
        enabledBackground = GradientDrawable().apply {
            setColor(ContextCompat.getColor(context, android.R.color.holo_blue_dark)) // Warna aktif
            cornerRadius = this@RegisterButton.cornerRadius.dpToPx(context)
        }

        disabledBackground = GradientDrawable().apply {
            setColor(ContextCompat.getColor(context, android.R.color.darker_gray)) // Warna tidak aktif
            cornerRadius = this@RegisterButton.cornerRadius.dpToPx(context)
        }
    }
